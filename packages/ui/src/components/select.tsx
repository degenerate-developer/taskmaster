  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        // Minimal styles
        variant === "minimal" &&
          "flex w-fit items-center justify-between text-sm outline-none border-none shadow-none p-1 disabled:cursor-not-allowed disabled:opacity-50",
